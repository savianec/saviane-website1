...
export type GLSLHillsProps = {
  /** CSS width, e.g. `100%` or `100vw` */
  width?: string;
  /** CSS height, e.g. `100%` or `100vh` */
  height?: string;
  className?: string;
  cameraZ?: number;
  planeSize?: number;
...
/**
 * WebGL terrain background using RawShaderMaterial + classic noise.
 * Client-only; pair with `dynamic(..., { ssr: false })` if you need zero SSR flash.
 */
          ...
          new THREE.RawShaderMaterial({
            ...
            fragmentShader: /* glsl */ `
              ...
              void main(void) {
                ...
                /* saviane: dark base + subtle forest green / gold wash */
                vec3 color = vec3(0.08, 0.12, 0.09);
